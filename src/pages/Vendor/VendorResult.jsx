...
export function VendorResult() {
  ...
  return (
    <ProjectStageShell stageNumber="03" title="能力结果" projectName={projectMeta?.projectName} outputLabel="设备声明摘要" >
